...
extern void proto_register_tracker_network_capture(void);
extern void proto_reg_handoff_tracker_network_capture(void);
...
#endif
{
    ...
    plugin.register_protoinfo = proto_register_tracker_network_capture;
    plugin.register_handoff = proto_reg_handoff_tracker_network_capture;
...
static struct ws_module module = {
    ...
    .home_url = "",
    .blurb = "Tracker network capture dissector",
