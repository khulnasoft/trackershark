...
#endif
{
    struct tracker_dissector_data *data = (struct tracker_dissector_data *)p;
    int node;
...
#endif
{
    ...
    file_type = wanted_field_get_str("tracker.args.magic_write.file_type");
...
#endif
{
    ...
    DISSECTOR_ASSERT((pathname = wanted_field_get_str("tracker.args.magic_write.pathname")) != NULL);
    file_type = wanted_field_get_str("tracker.args.magic_write.file_type");
...
void register_tracker_statistics(void)
{
    // needed for file types
    register_wanted_field("tracker.args.magic_write.file_type");
    ...
    event_counts_st = stats_tree_register_plugin("tracker", "tracker_events", "Tracker" STATS_TREE_MENU_SEPARATOR "Event Counts",
    ...
    file_types_st = stats_tree_register_plugin("tracker", "tracker_file_types", "Tracker" STATS_TREE_MENU_SEPARATOR "File Types",
        0, file_types_stats_tree_packet, file_types_stats_tree_init, NULL);
    stats_tree_set_first_column_name(file_types_st, "File Type");

    process_tree_st = stats_tree_register_plugin("tracker", "tracker_process_tree", "Tracker" STATS_TREE_MENU_SEPARATOR "Process Tree",
    ...
    process_tree_with_files_st = stats_tree_register_plugin("tracker", "tracker_process_tree_files", "Tracker" STATS_TREE_MENU_SEPARATOR "Process Tree (with files)",
    ...
    process_tree_with_network_st = stats_tree_register_plugin("tracker", "tracker_process_tree_network", "Tracker" STATS_TREE_MENU_SEPARATOR "Process Tree (with network)",
    ...
    process_tree_with_signatures_st = stats_tree_register_plugin("tracker", "tracker_process_tree_signatures", "Tracker" STATS_TREE_MENU_SEPARATOR "Process Tree (with signatures)",
    ...
    stats_tree_register_plugin("tracker", "tracker_events", "Tracker/Event Counts",
        0, event_counts_stats_tree_packet, event_counts_stats_tree_init, NULL);
    stats_tree_register_plugin("tracker", "tracker_file_types", "Tracker/File Types",
        0, file_types_stats_tree_packet, file_types_stats_tree_init, NULL);
    stats_tree_register_plugin("tracker", "tracker_process_tree", "Tracker/Process Tree",
        0, process_tree_stats_tree_packet, process_tree_stats_tree_init, process_tree_stats_tree_cleanup);
    stats_tree_register_plugin("tracker", "tracker_process_tree_files", "Tracker/Process Tree (with files)",
        0, process_tree_with_files_stats_tree_packet, process_tree_stats_tree_init, process_tree_stats_tree_cleanup);
    stats_tree_register_plugin("tracker", "tracker_process_tree_network", "Tracker/Process Tree (with network)",
        0, process_tree_with_network_stats_tree_packet, process_tree_stats_tree_init, process_tree_stats_tree_cleanup);
    stats_tree_register_plugin("tracker", "tracker_process_tree_signatures", "Tracker/Process Tree (with signatures)",
        0, process_tree_with_signatures_stats_tree_packet, process_tree_stats_tree_init, process_tree_stats_tree_cleanup);
#endif
}